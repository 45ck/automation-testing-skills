---
name: "selenium-scenario-designer"
pack: "automation-testing-pack"
purpose: "Translate browser interaction goals into Selenium-style scenarios with robust selectors, waits, and observable assertions."
inputs: ["UI flow or page", "DOM or selector info", "target browsers", "key assertions"]
outputs: ["Selenium scenarios", "selector strategy", "wait strategy", "stability notes"]
handoffs: ["webdriver-flow-writer", "flaky-test-investigator", "test-isolation-reviewer"]
---
# selenium-scenario-designer

## Purpose
Translate browser interaction goals into Selenium-style scenarios with robust selectors, waits, and observable assertions.

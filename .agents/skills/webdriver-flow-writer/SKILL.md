---
name: "webdriver-flow-writer"
pack: "automation-testing-pack"
purpose: "Write browser automation flows that sequence actions and assertions clearly while minimizing brittle waits and hidden assumptions."
inputs: ["scenario steps", "UI states", "navigation rules", "assertion targets"]
outputs: ["automation flow", "action/assertion sequence", "synchronization plan", "failure diagnostics notes"]
handoffs: ["selenium-scenario-designer", "flaky-test-investigator", "ui-test-scenario-writer"]
---
# webdriver-flow-writer

## Purpose
Write browser automation flows that sequence actions and assertions clearly while minimizing brittle waits and hidden assumptions.

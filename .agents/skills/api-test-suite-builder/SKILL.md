...
purpose: "Create an API-focused test suite covering contract correctness, status codes, payload validation, auth, and error handling."
inputs: ["API specification or routes", "request/response schema", "authentication rules", "business rules"]
outputs: ["API test matrix", "request cases", "response assertions", "negative cases"]
handoffs: ["fixture-and-test-data-builder", "test-isolation-reviewer", "regression-suite-curator"]
---
# api-test-suite-builder

## Purpose
Create an API-focused test suite covering contract correctness, status codes, payload validation, auth, and error handling.

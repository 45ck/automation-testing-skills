...
purpose: "Review whether tests can run independently without hidden ordering, shared mutable state, or environmental bleed-through."
inputs: ["test suite or scenario set", "shared resources", "setup/teardown behavior", "stateful dependencies"]
outputs: ["isolation findings", "coupling risks", "cleanup/reset recommendations", "parallelism notes"]
handoffs: ["fixture-and-test-data-builder", "mock-vs-stub-selector", "test-maintainability-auditor"]
---
# test-isolation-reviewer

## Purpose
Review whether tests can run independently without hidden ordering, shared mutable state, or environmental bleed-through.

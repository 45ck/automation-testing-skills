---
name: "ui-test-scenario-writer"
pack: "automation-testing-pack"
purpose: "Define end-to-end UI automation scenarios around real user goals, key paths, validation behavior, and important regressions."
inputs: ["user journeys", "screen or flow map", "critical interactions", "target browsers/devices"]
outputs: ["UI scenarios", "step sequences", "assertion points", "risk notes"]
handoffs: ["fixture-and-test-data-builder", "webdriver-flow-writer", "regression-suite-curator"]
---
# ui-test-scenario-writer

## Purpose
Define end-to-end UI automation scenarios around real user goals, key paths, validation behavior, and important regressions.
